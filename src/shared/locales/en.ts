...
const en: Record<string, string> = {
  ...
  clipboard_desc: 'Configure how Noto captures and stores clipboard history.',
  ...
  data_heading: 'Data',
  data_desc: 'Manage your clipboard history.',
  data_management: 'Data Management',
  data_management_desc: 'Export your clipboard history to a JSON file or import from a previous export.',
  data_export: 'Export Data',
  data_import: 'Import Data',
  data_danger_zone: 'Danger Zone',
  data_entries_stored: 'entries stored.',
  data_delete_warning: 'Permanently deletes all clipboard entries. This cannot be undone.',
  ...
  prompt_lock_heading: 'Prompt Lock',
